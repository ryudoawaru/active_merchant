...
class TappayTest < Test::Unit::TestCase
  def setup
    @gateway = TappayGateway.new(some_credential: 'login', another_credential: 'password')
  ...
  def successful_purchase_response
    %(
      ...
      $ DEBUG_ACTIVE_MERCHANT=true ruby -Itest \
        test/remote/gateways/remote_tappay_test.rb \
